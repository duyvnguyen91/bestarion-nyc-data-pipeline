...
This Repo contains Terraform configurations to provision GCP infrastructure for the Bestarion NYC Data Pipeline project.
...
Deploy Git secret for gitsync function
```bash
kubectl create secret generic airflow-git-ssh \
  --namespace airflow \
  --from-file=gitSshKey='{{ your private key }}'
```
